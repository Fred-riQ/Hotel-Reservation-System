...
CALLBACK_URL = "https://dd5f-102-0-15-200.ngrok-free.app/daraja/callback"

# Email configuration
SMTP_SERVER = "smtp.gmail.com"  # Replace with your SMTP server
SMTP_PORT = 587  # Replace with your SMTP port
SENDER_EMAIL = "belascohotel@gmail.com"  
SENDER_PASSWORD = "pciu hmmg jtkm rasu"  
...
def send_welcome_email(recipient_email, username):
    ...
    try:
        ...
        print(Fore.GREEN + "✅ Welcome email sent successfully!" + Style.RESET_ALL)
    except Exception as e:
        print(Fore.RED + f"❌ Failed to send welcome email: {e}" + Style.RESET_ALL)

def send_booking_email(recipient_email, username, room_info, check_in_date, check_out_date):
    ...
    try:
        with smtplib.SMTP(SMTP_SERVER, SMTP_PORT) as server:
            ...
            server.login(SENDER_EMAIL, SENDER_PASSWORD)
            server.sendmail(SENDER_EMAIL, recipient_email, msg.as_string())
        print(Fore.GREEN + "✅ Booking confirmation email sent successfully!" + Style.RESET_ALL)
    except Exception as e:
        print(Fore.RED + f"❌ Failed to send booking confirmation email: {e}" + Style.RESET_ALL)
